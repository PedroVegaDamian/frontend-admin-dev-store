...
<template>
  <div class="flex justify-end mr-4">
    <q-btn no-caps color="primary" label="Agregar Producto" @click="isShowProductCreateModal = true" />
    <ProductCreateModal @trigger-hide="onReset" v-model="isShowProductCreateModal">
      <ProductForm @on-reset="onReset" @on-submit="handleSubmit" v-model="newProduct" />
    </ProductCreateModal>
  </div>
