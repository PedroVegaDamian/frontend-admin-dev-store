    ...
    <q-table class="my-sticky-last-column-table" row-key="_id" title="Productos" :columns="columns" :loading="isLoading"
      ...
      <template v-slot:body-cell-actions="props">
        <td class="text-center flex items-center justify-center">
          ...
          <BaseModal type="icon" title="edit" color="warning" v-model="showDialog" @open-dialog="showDialog = true">
            <!-- TODO: editProduct , form reutilizable -->
            <FormCreateProduct @closed-dialog="showDialog = false" :product="props.row" />
          </BaseModal>
